---
name: patent-specification-reviewer-CN
...
脚本输出 `cn-patent-review-raw-report/v2`，字段集合由 [CN v2 审查规范](../patent-reviewer-CN/references/cn-review-contract-v2.json) 固定，不得增删：
