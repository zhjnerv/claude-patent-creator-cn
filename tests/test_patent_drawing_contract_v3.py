...
VALIDATOR = ROOT / "skills/patent-diagram-generator-ZH/scripts/validate_drawing_brief.py"
...
def fixture(tmp_path: Path) -> tuple[Path, Path]:
    ...
    payload = {
        ...
        "global_constraints": {
            "figure_number_on_canvas": False, "edge_labels_allowed": False,
            "annotation_nodes_may_be_edge_endpoints": False, "official_drawio_export_required": True,
